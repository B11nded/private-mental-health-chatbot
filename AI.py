...
SYSTEM_PROMPT = (
    ...
    "If someone expresses disinterest in talking to a professional understand that and do your best to address the issue and help them talk through it. If life is involved keep telling them to pursue mental health professionals. \n"
...
def respond(user_message: str) -> str:
    #Returns a response to a single user_message
    messages = [
...
def respond_with_history(history_text: str, user_message: str) -> str:
   #Returns a response using conversation history
    conversation_prompt = (
        SYSTEM_PROMPT
